...
module.exports.run = async (client, message, args) => {
    ...
    .addField('**__General:__**', `:rosette: **Level:** ${(player.achievements.bedwars_level) || 0}
    ...
    .addField('**__Solo:__**', `> **Beds Broken:** ${(player.stats.Bedwars.eight_one_beds_broken_bedwars || 0)}
    ...
    .addField('**__Doubles:__**', `> **Beds Broken:** ${(player.stats.Bedwars.eight_two_beds_broken_bedwars || 0)}
    ...
    .addField('**__3v3v3v3:__**', `> **Beds Broken:** ${(player.stats.Bedwars.four_three_beds_broken_bedwars || 0)}
    ...
    .addField('**__4v4v4v4:__**', `> **Beds Broken:** ${(player.stats.Bedwars.four_four_beds_broken_bedwars || 0)}
    ...
    .addField('**__Overall:__**', `> **Beds Broken:** ${(player.stats.Bedwars.beds_broken_bedwars || 0)}
