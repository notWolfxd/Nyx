...
module.exports.run = async (client, message, args) => {
    ...
    if (message.guild.id == "576567811552313361") return;
  ...
  message.channel.send("Thank you for your suggestion, it has been sent to the suggestion area for players to vote on!");
